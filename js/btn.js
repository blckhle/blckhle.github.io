const LiquidButton = class LiquidButton {
  constructor(svg) {
    ...
    this.width = options.width * 1 || 115;
    this.height = options.height * 1 || 115;
   ...
   /* this.color1 = options.color1 || '#36DFE7';
    ...
    this.color1 = options.color1 || '#0000003ds';
    this.color2 = options.color2 || '#0000003d';
    this.color3 = options.color3 || '#0000003d';
    this.textColor = options.textColor || '#FFFFFF';
