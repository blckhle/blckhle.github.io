...
const spaceShip = {
 ...
 create( scene ) {
  ...
  objLoader.load( 'models/SpaceFighter01/SpaceFighter01.obj', ship => {
   ship.position.set( 0, -400, 0 );
   ship.rotation.set( 0, -0.15, 0 );
   ship.traverse( child => {
...
window.addEventListener( 'load', e => {
 ...
 textureLoader.load( 'ship', 'models/SpaceFighter01/F01_512.jpg' ); 
});
